  ...
  return (
    <>
      ...
      <div className='px-[35px]'>
        <Link to='#' style={{borderColor: COLOR.gray200}} className='border w-full h-[50px] rounded-[5px] flex items-center px-[23px] shadow-[1px_1px_4px_rgba(0,0,0,0.25)] hover:opacity-20'>
