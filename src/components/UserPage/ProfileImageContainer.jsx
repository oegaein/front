...
const ProfileImageContainer = ({
	...
	return (
		<>
			<SettingStyle
				className={`relative h-[160px] px-[30px] bg-[${COLOR.purple1}]`}
			>
				...
				<div
					className={`profile-container flex justify-center items-center bg-white h-[186px] w-[186px]
        z-10 absolute translate-y-[calc(-50%)] ${path === '/mypage' ? 'left-[40px]' : 'left-[50%] translate-x-[calc(-50%)]'} top-[100%] rounded-[50%]`}
				>
					...
					{path === '/mypage' && (
						<div
							className={`profile-perfection z-20 absolute left-[150px] bottom-[14px] w-[45px] h-[45px] flex justify-center items-center rounded-[50%]`}
						>
							80%
						</div>
					)}
