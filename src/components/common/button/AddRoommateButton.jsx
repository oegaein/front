...
const AddRoommateButton = () => {
  return (
    <SettingStyle className='rounded-[20px] w-[109px] h-[44px] flex justify-center items-center fixed z-10 bottom-[110px] right-[13px] shadow-[2px_2px_10px_rgba(0,0,0,0.25)] min-[393px]:right-[calc(50%-12rem)]'>
